...
class VideoAgent(Agent):
    ...
    def _generate_script(self, topic: str) -> str:
        ...
        try:
            with open(
                    os.path.join(topic_dir, 'meta.json'), 'w',
    ...
    def _generate_assets_from_script(self, script_path: str,
                                     topic: str) -> str:
        """
    ...
    def _synthesize_video(self, asset_info_path: str) -> Union[str, None]:
        ...
        """
        print(
            f'[video_agent] Starting final video synthesis from {asset_info_path}...'
        )
