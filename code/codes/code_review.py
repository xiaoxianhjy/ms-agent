...
""" # noqa
    ...
    async def generate_code_review_tool_args(
            self, messages: List[Message]) -> Dict[str, Dict[str, str]]:
        ...
        for i, task in enumerate(tasks):
            ...
            query = task['query']
            try:
                metadata = ArtifactCallback.extract_metadata(
                ...
                # should not happen
                code = (
                    f'Cannot fetch the code filename from the prompt of subtask: ```text\n{query}```\n '
