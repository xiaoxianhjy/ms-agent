...
"""
        ...
        if hasattr(config, 'generation_config') and getattr(config.generation_config, 'stream', False):
            message = None
    ...
    def hot_fix_code_piece(last_message_content):
        ...
        last_message_content = last_message_content.replace('```python\n', '<code>\n')
        last_message_content = last_message_content.replace('```jsx\n', '<code>\n')
        last_message_content = last_message_content.replace('```java\n', '<code>\n')
